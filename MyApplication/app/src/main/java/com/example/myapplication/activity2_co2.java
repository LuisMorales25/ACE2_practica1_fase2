...
public class activity2_co2 extends AppCompatActivity {

    private BarChart barChart;
    private String[]gases=conexion.fechas;//new String[]{"Co","Co2","UV"};
    private  int[]sale=conexion.airemin;//new int[]{3,5,2};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_activity2_co2);
    ...
    public void createCharts(){
        ...
        barChart.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
            ...
            public void onValueSelected(Entry e, Highlight h) {
                ...
                Toast.makeText(activity2_co2.this,aux2,Toast.LENGTH_SHORT).show();
            }
