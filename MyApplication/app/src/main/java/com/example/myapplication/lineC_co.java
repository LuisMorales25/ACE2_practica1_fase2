...
public class lineC_co extends AppCompatActivity {

    private static final String TAG = "lineC";

    private LineChart mChart;
    private String[]gases=conexion.fechas;//new String[]{"Co","Co2","UV","pedo","humo","comida"};
    private  int[] datos=conexion.monoxidomax;//new double[]{60.2,40.2,55.5,70,75.8,65};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_line_c_co);
        ...
        mChart.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
            ...
            public void onValueSelected(Entry e, Highlight h) {
                ...
                Toast.makeText(lineC_co.this,aux2,Toast.LENGTH_SHORT).show();
            }
