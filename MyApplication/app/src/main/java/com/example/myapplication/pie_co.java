    ...
    public void createCharts(){
        ...
        pieChart.setOnChartValueSelectedListener(new OnChartValueSelectedListener() {
            ...
            public void onValueSelected(Entry e, Highlight h) {
                ...
                Toast.makeText(pie_co.this,aux2,Toast.LENGTH_SHORT).show();
            }
